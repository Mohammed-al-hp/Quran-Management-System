...
class _AddTeacherScreenState extends State<AddTeacherScreen> with SingleTickerProviderStateMixin {
  ...
  void _saveTeacher() {
    if (_formKey.currentState!.validate()) {
      ...
      final newTeacher = TeacherModel(
        ...
        name: _name,
        joinDate: '${DateTime.now().year}-${DateTime.now().month.toString().padLeft(2, '0')}-${DateTime.now().day.toString().padLeft(2, '0')}',
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('إضافة محفظ جديد', style: TextStyle(fontWeight: FontWeight.bold)),
      ),
      body: Form(
        key: _formKey,
            ...
            children: [
                    ...
                    return Transform.scale(
                      ...
                      child: Container(
                        ...
                        child: CircleAvatar(
                          ...
                          child: const Icon(Icons.add_a_photo, size: 40, color: AppTheme.emeraldGreen),
                        ),
                      ),
                    );
                  },
              ...
              TextFormField(
                decoration: InputDecoration(
                  ...
                  filled: true,
                  fillColor: Theme.of(context).brightness == Brightness.dark ? AppTheme.cardDark : Colors.white,
                ),
              ...
              const Text('اختر حلقة التحفيظ:', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
                ...
                children: circles.map((circle) {
                  ...
                  return ChoiceChip(
                    ...
                    labelStyle: TextStyle(
                      color: isSelected ? AppTheme.emeraldGreen : (Theme.of(context).brightness == Brightness.dark ? Colors.white : Colors.black87),
                      fontWeight: isSelected ? FontWeight.bold : FontWeight.normal,
                    ),
                    shape: RoundedRectangleBorder(
                      borderRadius: BorderRadius.circular(12),
                      side: BorderSide(
                        color: isSelected ? AppTheme.emeraldGreen : Colors.grey.withOpacity(0.3),
                      ),
                    ),
                  );
                }).toList(),
              ...
              ElevatedButton(
                ...
                child: const Text('إضافة المحفظ', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
              ),
            ],
          ),
        ),
